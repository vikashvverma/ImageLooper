angular.module('imageLooperApp').factory('chartService', function($rootScope, $http, $q, $log, localStorageService) {
    var chart = {};
    return {
        ...
        getChart: function(type, data) {
            ...
            var options = {
                ...
                title: {
                    text: 'Demographic of viewers (in %)'
                },
                subtitle: {
                    text: ''
                },
                ...
                series: [{
                    name: 'Demographic',
                    data: data.data || [54, 12, 14, 15, 54, 84, 54, 12, 52, 65, 0]
                }]
            };
            return options;
        },
